...
from ckanext.customapi.utils import package_collaborator_org_list, add_package_collaborator, set_delete_package_collaborator
...
class CustomapiPlugin(plugins.SingletonPlugin):
    ...
    def get_blueprint(self):
        ...
        def welcome_api():
            ...
            """
            message = "Welcome to the Virtual World 21.1!"
